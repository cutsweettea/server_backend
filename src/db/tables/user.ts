...
export default class Users {
  ...
  public async createUser(
    ...
    if (login_name == user_name)
      return Promise.reject("login name must be different than username");
    ...
    // attempt insert
    console.log(
      `creating account with ln=${login_name}, usn=${user_name}, tag=${tag}, pwd=${pwd_info.hash}, salt=${pwd_info.salt} pgp=${pgp}, rank=${rank}, refer=${refer}, pfp_url=${pfp_url}, bio=${bio}`,
    );
    let insert_res;
    try {
